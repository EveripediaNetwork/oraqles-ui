export const apElectionAbi = [
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: '_requestId', type: 'bytes32' },
      { internalType: 'bytes32', name: '_votes', type: 'bytes32' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'resultNow', type: 'uint256' },
      { internalType: 'uint256', name: 'resultBlock', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
